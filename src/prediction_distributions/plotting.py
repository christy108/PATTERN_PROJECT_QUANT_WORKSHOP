...
def plot_from_dict(prediction_dict, returns_percentile, i):
    ...
    ax1.text(returns_percentile, ax1.get_ylim()[1] * 0.9, f' Long Trade Threshold', 
    ...
    # Optional: Add a text label next to the line
    ax1.text(-returns_percentile, ax1.get_ylim()[1] * 0.9, f' Short Trade Threshold', 
             color='firebrick', fontweight='bold')
    
    ax1.set_title('Distribution of Predicted Expected Returns', fontsize=14, fontweight='bold')
